...
Credits.prototype = {
  ...
  addCredit: function(task, author) {
    ...
    var authorText = game.add.text(610, 900, author, authorStyle);
    var taskText = game.add.text(610, 950, task, taskStyle);
  ...
  create: function () {
    ...
    this.addCredit('Developer', 'Erick Ferreira');
    this.addCredit('Developer', 'Felipe Lisboa');
    this.addCredit('Developer', 'Carlos Rian');
    this.addCredit('Music', 'Kevin Macleod');
    this.addCredit('Music', 'Human Antagonist ');
